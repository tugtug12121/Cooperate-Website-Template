...
export default function indexPage(_req: Request, _res: Response): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<section style="max-width:1100px;margin:90px auto;padding:0 20px;">
  <h2 class="reveal" style="text-align:center;font-size:2.4rem;font-weight:700;color:#0b1f3b;">
    Why Choose Us
  </h2>
